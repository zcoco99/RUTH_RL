...
class MapaEnv(gym.Env):
    ...
    def resetmiddle(self):
        # self.state = np.array([0.50, 0.25]) 
        # randomindex = random.randint(0,2)
        # if randomindex == 0:
        #     self.state = np.random.rand(2) * [0.45, 1.00] + np.array([0.00, 0.00]) 
        # if randomindex == 1:
        #     self.state = np.random.rand(2) * [0.10, 0.48] + np.array([0.45, 0.52])
        # if randomindex == 2:
        #     self.state = np.random.rand(2) * [0.45, 1.00] + np.array([0.55, 0.00])
        ...
        # if randomindex == 2:
        #     self.state = np.random.rand(2) * [0.30, 0.50] + np.array([0.55, 0.40])
        ...
        # allindex = [np.array([0.75,0.25]),np.array([0.70,0.75]),np.array([0.25, 0.75])] 
        # self.state = allindex[index] 
