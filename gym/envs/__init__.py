...
register(
    id='kelin-v0',
    entry_point='gym.envs.kelin:MoveUr5RuthEnv',
...
register(
    id='Map-v0',
    entry_point='gym.envs.maps:MapEnv',
...
register(
    id='Mapb-v0',
    entry_point='gym.envs.maps:MapbEnv',
    max_episode_steps=60, 
)
...
register(
    id='Mapc-v0',
    entry_point='gym.envs.maps:MapcEnv',
    max_episode_steps=60, 
)

register(
    id='Mapa-v0',
    entry_point='gym.envs.maps:MapaEnv',
    max_episode_steps=60, 
)
...
register(
    id='Swimmers-v0',
    entry_point='gym.envs.mujocost.swimmer_s:SwimmersEnv',
    max_episode_steps=100,
...
register(
    id='Swimmert-v0',
    entry_point='gym.envs.mujocost.swimmer_t:SwimmertEnv',
    max_episode_steps=100,
    # reward_threshold=360.0,
)
...
register(
    id='HalfCheetahs-v0',
    entry_point='gym.envs.mujocost.half_cheetah_s:HalfCheetahsEnv',
...
register(
    id='HalfCheetaht-v0',
    entry_point='gym.envs.mujocost.half_cheetah_t:HalfCheetahtEnv',
    max_episode_steps=10,
#    reward_threshold=4800.0,
)
...
register(
    id='Ants-v0',
    entry_point='gym.envs.mujocost.ant_s:AntsEnv',
    max_episode_steps=5,
...
register(
    id='Antt-v0',
    entry_point='gym.envs.mujocost.ant_t:AnttEnv',
    max_episode_steps=5,
    # reward_threshold=6000.0,
)
...
register(
    id='Hoppers-v0',
    entry_point='gym.envs.mujocost.hopper_s:HoppersEnv',
    max_episode_steps=100,
...
register(
    id='Hoppert-v0',
    entry_point='gym.envs.mujocost.hopper_t:HoppertEnv',
    max_episode_steps=100,
    # reward_threshold=3800.0,
)
...
register(id='HumanoidBulletEnvp-v0',
         entry_point='gym.envs.pybullet_envs.gym_locomotion_envs:HumanoidBulletEnv',
         max_episode_steps=1000)

register(id='HumanoidBulletEnvptar-v0',
         entry_point='gym.envs.pybullet_envs.gym_locomotion_envs:HumanoidBulletEnvtar',
         max_episode_steps=1000)

register(id='HumanoidBulletEnvptara-v0',
         entry_point='gym.envs.pybullet_envs.gym_locomotion_envs:HumanoidFlagrunHarderBulletEnv',
         max_episode_steps=1000)


register(id='HumanoidFlagrunBulletEnvp-v0',
         entry_point='gym.envs.pybullet_envs.gym_locomotion_envs:HumanoidFlagrunBulletEnv',
         max_episode_steps=1000)

register(id='HumanoidFlagrunHarderBulletEnvp-v0',
         entry_point='gym.envs.pybullet_envs.gym_locomotion_envs:HumanoidFlagrunHarderBulletEnv',
         max_episode_steps=1000)
...
register(
    id='Point-v0',
    entry_point='gym.envs.mujoco.point:PointEnv',
    max_episode_steps=20,
)

register(
    id='PointWall-v0',
    entry_point='gym.envs.mujoco.point_wall:PointWallEnv',
    max_episode_steps=20,
)
...
register(
    id='Ant-v2',
    entry_point='gym.envs.mujoco.ant:AntEnv',
...
for reward_type in ['sparse', 'dense']:
    ...
    # Fetch 
    register(
        id='PandaFetchReach{}-v1'.format(suffix),
        entry_point='gym.envs.panda:FetchReachEnv',
        kwargs=kwargs,
        max_episode_steps=50,
    )
    ...
    # Fetch 
    register(
        id='RealPandaFetchReach{}-v1'.format(suffix),
        entry_point='gym.envs.pandareal:FetchReachEnv',
        kwargs=kwargs,
        max_episode_steps=50,
    )
...
for reward_type in ['sparse', 'dense']:
    ...
    register(
        id='Pileimi{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:PileImiEnv',
        kwargs=kwargs,
        max_episode_steps=20,
    )
    ...
    register(
        id='Pilearound{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:PileAroundEnv',
        kwargs=kwargs,
        max_episode_steps=20,
    )
    
    register(
        id='Pilegroup{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:PileGroupEnv',
        kwargs=kwargs,
        max_episode_steps=100,
    )
    
    register(
        id='Piletable{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:PileTableEnv',
        kwargs=kwargs,
        max_episode_steps=100,
    )
    
    register(
        id='Pilestack{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:PileStackEnv',
        kwargs=kwargs,
        max_episode_steps=100,
    )
    
    register(
        id='Piletable0{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:PileTable0Env',
        kwargs=kwargs,
        max_episode_steps=50,
    )
