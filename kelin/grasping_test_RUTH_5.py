...
#            contact_point3 = pcd5[:3, 230]
            # contact_points = np.load("..\Contact_Points\Ruth\Ruth_Banana.npy")
            ...
            cal_contact_pt = np.load(".\Contact_Points\Ruth\Ruth_Banana.npy")
            # visualise_contact_points(cal_contact_pt)
...
#            h/g
        ...
        # Plot ruth 2 motor values
        # fig = plt.figure()
        # for i in range(1000):
        #     plt.scatter(i, ruth_all_vals[5])
        #     plt.pause(0.01)
