...
class Logger:
    ...
    def save_state(self, models, itr=None):
        """
...
#                            update='new'
    ...
    def save_video(self, visual_obs, info, fpath, vr='video'):
        """
        ...
        if info[0]=='Trans' or info[0]=='Con':
            video_name = info[0]+'-'+info[1]+'-' +info[2]+'-'+info[3] +'.mp4'
        elif info[0]=='Record':
            video_name = info[1]+'.mp4'
        else:
        ...
        cv2.imwrite(osp.join(record_dir, str(info[1])+'.jpg'), visual_obs[-1])
